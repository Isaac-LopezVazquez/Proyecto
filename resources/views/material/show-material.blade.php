...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 d-flex align-items-center">
                <div class="card w-100">
                    ...
                    <form id="agregarPrendaForm" action="{{ route('material.agrega-prenda', $material) }}" method="POST">
                        @csrf
                        <div class="row justify-content-evenly">
                            <div class="col-4">
                                <div class="col">
                                    <select name="prenda_id" class="form-select" aria-label="Default select example" required>
                                        <option value="" selected>Selecciona la prenda</option>
    ...
    <script>
        document.getElementById('agregarPrendaForm').addEventListener('submit', function(e) {
            var selectElement = document.querySelector('select[name="prenda_id"]');
