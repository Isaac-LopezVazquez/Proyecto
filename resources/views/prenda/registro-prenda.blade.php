...
<form action="{{ route('prenda.store') }}" method='POST'>
    ...
    <input type='text' name='tipo' id='tipo' value="{{old('tipo')}}"><br>
    @error('tipo')
        <h4>{{ $message}}</h4>
    @enderror
    <br>
    ...
    <input type='number' name='talla' id='talla'  value="{{old('talla')}}"><br>
    @error('talla')
        <h4>{{ $message}}</h4>
    @enderror
    <br>
    ...
    <input type='number' name='costo' id='costo'  value="{{old('costo')}}"><br>
    @error('costo')
        <h4>{{ $message}}</h4>
    @enderror
    <br>
